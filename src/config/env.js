...
export const env = {
  ...
  MERCOS_COMPANY_TOKEN_ATOMY: isSandbox
    ? process.env.MERCOS_COMPANY_TOKEN_ATOMY_SANDBOX
    : process.env.MERCOS_COMPANY_TOKEN_ATOMY,
  MERCOS_COMPANY_TOKEN_ANKORFIT: isSandbox
    ? process.env.MERCOS_COMPANY_TOKEN_ANKORFIT_SANDBOX
    : process.env.MERCOS_COMPANY_TOKEN_ANKORFIT,
};